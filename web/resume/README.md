...
1. Ожидается, что вы выложите ваш проект на публичный репозиторий (например, GitHub), напишите краткое описание и инструкцию по установке (если применимо). 
2. Предоставьте ссылку на репозиторий и рабочий пример приложения (например, используя GitHub Pages) для проверки.
3.	Добавьте результаты с описанием сделанной работы в отчёт
4.	[Сохраните в формате PDF и загрузите в курс](https://eios.sibsutis.ru/mod/assign/view.php?id=165561)
